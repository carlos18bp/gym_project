<template>
    <SlideBar>
        <div class="w-full p-5 rounded-lg border-2 border-stroke bg-terciary">
            <!-- Title -->
            <div>
                <h1 class="text-primary text-xl font-semibold">Información del proceso</h1>
            </div>
            ...
            <div class="mt-4 space-y-3">
                        ...
                        <Combobox as="div" v-model="selectedCaseType" @update:modelValue="query = ''">
                            ...
                            <div class="relative mt-2">
                                ...
                                <ComboboxOptions v-if="filteredCaseTypes.length > 0"
                                    ...
                                    <ComboboxOption v-for="caseType in filteredCaseTypes" :key="caseType.id"
                                        :value="caseType" as="template" v-slot="{ active, selected }">
                                        <li
                                            :class="['relative cursor-default select-none py-2 pl-3 pr-9', active ? 'bg-secondary text-white' : 'text-primary']">
                                            <span :class="['block truncate', selected && 'font-semibold']">
                                                {{ caseType.name }}
                                            </span>

                                            <span v-if="selected"
                                                :class="['absolute inset-y-0 right-0 flex items-center pr-4', active ? 'text-white' : 'text-secondary']">
                ...
                <div>
                    ...
                    <div class="flex items-center gap-3 font-medium">
                        ...
                        <button class="flex items-center px-2 py-1 rounded-md text-sm text-secondary bg-selected-background">
