                ...
                <ul role="list" class="flex flex-1 flex-col gap-y-5">
                  ...
                  <li>
                    <ul role="list" class="-mx-2 space-y-1">
                      <li v-for="item in navigation" :key="item.name">
                        <a :href="item.href"
                          :class="[item.current ? 'bg-gray-50 text-secondary' : 'text-gray-700 hover:bg-gray-50 hover:text-secondary', 'group flex gap-x-3 rounded-md p-2 text-sm font-semibold leading-6']">
                          <component :is="item.icon"
                            :class="[item.current ? 'text-secondary' : 'text-gray-400 group-hover:text-secondary', 'h-6 w-6 shrink-0']"
                            aria-hidden="true" />
                          {{ item.name }}
                        </a>
                      </li>
                  ...
                  <li class="mt-auto">
                    <a href="#"
                      ...
                      <QuestionMarkCircleIcon class="h-6 w-6 shrink-0 text-gray-400 group-hover:text-secondary"
                        aria-hidden="true" />
                      Soporte
                    </a>
                  </li>
        ...
        <ul role="list" class="flex flex-1 flex-col gap-y-5">
          ...
          <li>
            <ul role="list" class="-mx-2 space-y-1">
              <li v-for="item in navigation" :key="item.name">
                <a :href="item.href"
                  :class="[item.current ? 'bg-selected-background text-secondary' : 'text-primary hover:bg-gray-50 hover:text-secondary', 'group flex gap-x-3 rounded-md p-2 text-sm font-semibold leading-6']">
                  <component :is="item.icon"
                    :class="[item.current ? 'text-secondary' : 'text-primary group-hover:text-secondary', 'h-6 w-6 shrink-0']"
                    aria-hidden="true" />
                  {{ item.name }}
                </a>
              </li>
          ...
          <li class="mt-auto">
            <a href="#"
              ...
              <QuestionMarkCircleIcon class="h-6 w-6 shrink-0 text-primary group-hover:text-secondary"
                aria-hidden="true" />
              Soporte
            </a>
          </li>
