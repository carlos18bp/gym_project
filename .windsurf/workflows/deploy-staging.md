...
6. Build the frontend (requires nvm for Node 22.13.0):
```bash
bash -c 'export NVM_DIR="$HOME/.nvm"; source "$NVM_DIR/nvm.sh"; nvm use; cd /home/ryzepeck/webapps/gym_project_staging/frontend && npm ci && npm run build'
```
