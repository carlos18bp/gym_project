from .user import User, ActivityFeed
...
from .dynamic_document import DynamicDocument, DocumentVariable, RecentDocument
from .legal_update import LegalUpdate

__all__ = [
    'User', 'Process', 'Stage', 'CaseFile', 'Case', 'ActivityFeed',
    'LegalRequest', 'LegalRequestType', 'LegalDiscipline', 'LegalRequestFiles',
    'LegalDocument', 'DynamicDocument', 'DocumentVariable', 'LegalUpdate', 'RecentDocument', 'RecentProcess'
]