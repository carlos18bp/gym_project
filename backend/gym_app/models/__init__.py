...
from .dynamic_document import DynamicDocument, DocumentVariable, DocumentSignature, RecentDocument, Tag, DocumentVisibilityPermission, DocumentUsabilityPermission, DocumentFolder
...
__all__ = [
    ...
    'Tag', 'DocumentVisibilityPermission', 'DocumentUsabilityPermission', 'DocumentFolder'
]